      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.invoiceInfo}>#{invoice.number}</Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={{ fontWeight: "bold" }}>{invoice.project.client.name}</Text>
          {invoice.project.client.company && (
            <Text>{invoice.project.client.company}</Text>
          )}
          {invoice.project.client.email && (
            <Text>{invoice.project.client.email}</Text>
          )}
          {invoice.project.client.phone && (
            <Text>{invoice.project.client.phone}</Text>
          )}
          {invoice.project.client.address && (
            <Text>{invoice.project.client.address}</Text>
          )}
        </View>
        ...
        <Text style={styles.footer}>
          Thank you for your business! | Generated by FreelancerCRM
        </Text>
      </Page>
    </Document>
  )
